...
contract ExampleFlashSwap is ISafeswapCallee {
    ...
    function safeswapCall(
        ...
        if (amountToken > 0) {
            ...
            uint256 amountRequired = SafeswapLibrary.getAmountsIn(factory, amountToken, path)[0];
            ...
            uint256 amountRequired = SafeswapLibrary.getAmountsIn(factory, amountETH, path)[0];
