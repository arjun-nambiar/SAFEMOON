...
describe("SafeswapV2Router{01,02}", () => {
  ...
  it("addLiquidity", async () => {
    ...
    console.log("\x1b[36m%s\x1b[0m", "pairAddress", pairAddress);
    const test = await pair.getReserves();
  ...
  it("addLiquidity - 02", async () => {
    const token0Amount = expandTo18Decimals(10);
    const token1Amount = expandTo18Decimals(40);
  ...
  describe("swapExactTokensForTokens", () => {
    ...
    const expectedOutputAmount = ethers.BigNumber.from("1624790619765494137");
  ...
  describe("swapTokensForExactTokens", () => {
    const token0Amount = expandTo18Decimals(5);
    const token1Amount = expandTo18Decimals(10);
    const expectedSwapAmount = ethers.BigNumber.from("572737686139747996");
  ...
  describe("swapTokensForExactTokens - 02", () => {
    const token0Amount = expandTo18Decimals(50);
    const token1Amount = expandTo18Decimals(100);
    const expectedSwapAmount = ethers.BigNumber.from("5727376861397479955");
  ...
  describe("swapExactETHForTokens - 02", () => {
  ...
  describe("swapTokensForExactETH - 02", () => {
  ...
  describe("swapExactTokensForETH - 02", () => {
    const WETHPartnerAmount = expandTo18Decimals(50);
    const ETHAmount = expandTo18Decimals(100);
    const swapAmount = expandTo18Decimals(10);
    const expectedOutputAmount = ethers.BigNumber.from("16247906197654941373");
  ...
  describe("swapETHForExactTokens - 02", () => {
    const WETHPartnerAmount = expandTo18Decimals(100);
    const ETHAmount = expandTo18Decimals(50);
    const expectedSwapAmount = ethers.BigNumber.from("5727376861397479955");
    const outputAmount = expandTo18Decimals(10);
