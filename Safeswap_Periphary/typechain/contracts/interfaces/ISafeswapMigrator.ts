...
export interface ISafeswapMigratorInterface extends utils.Interface {
  functions: {
...
export interface ISafeswapMigrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISafeswapMigratorInterface;
