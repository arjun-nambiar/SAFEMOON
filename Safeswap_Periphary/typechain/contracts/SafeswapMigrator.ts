...
export interface SafeswapMigratorInterface extends utils.Interface {
  functions: {
...
export interface SafeswapMigrator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SafeswapMigratorInterface;
