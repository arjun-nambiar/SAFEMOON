...
export interface ISafeswapRouter02OldInterface extends utils.Interface {
  functions: {
...
export interface ISafeswapRouter02Old extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISafeswapRouter02OldInterface;
