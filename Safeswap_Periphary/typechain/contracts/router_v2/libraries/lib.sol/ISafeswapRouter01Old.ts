...
export interface ISafeswapRouter01OldInterface extends utils.Interface {
  functions: {
...
export interface ISafeswapRouter01Old extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISafeswapRouter01OldInterface;
