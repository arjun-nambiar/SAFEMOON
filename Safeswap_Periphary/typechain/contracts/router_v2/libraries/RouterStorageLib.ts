...
export interface RouterStorageLibInterface extends utils.Interface {
  functions: {
...
export interface RouterStorageLib extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: RouterStorageLibInterface;
