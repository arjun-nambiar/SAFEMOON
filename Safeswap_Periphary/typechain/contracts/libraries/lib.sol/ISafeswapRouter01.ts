...
export interface ISafeswapRouter01Interface extends utils.Interface {
  functions: {
...
export interface ISafeswapRouter01 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ISafeswapRouter01Interface;
